      ...
      <div className="flex flex-col md:flex-row items-center justify-center md: mt-10">
        <div className="flex mt-5 md:mt-20 md:space-y-10 space-y-0 md:space-x-0 space-x-10 md:flex-col md:mr-44">
          ...
          <Link href={"https://github.com/Jessuss0"}>
            <button
              href="/"
              className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-gray-900 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
            >
              <svg
                className=" h-8 w-8 md:w-12 md:h-12"
                viewBox="0 0 15 15"
          ...
          <button
            href="/"
            onClick={() => mail()}
            className="group w-12 h-12 md:w-16 md:h-16 flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-gray-900 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
          >
            <Image
              className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert "
              src={mailImage}
        ...
        <div className="flex items-center justify-center mt-20">
          <div className="flex flex-col items-center justify-center w-72 min-h-[350px] p-5 bg-gray-300 shadow-2xl shadow-blue-700 rounded-xl md:w-96">
            <form
