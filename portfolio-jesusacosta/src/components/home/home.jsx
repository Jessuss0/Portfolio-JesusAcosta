...
export default function Home() {
  return (
    <div className="h-screen flex flex-col justify-center items-start p-8">
      <div>
        <h2 className="text-5xl mb-4 font-black">Hi i'am Jesús Acosta</h2>
        <h2 className="text-7xl text-purple-600 mb-8 font-black">Full stack web Developer!</h2>
      </div>
